...
public class AnimalBackAndForthTest {
    ...
    public void breedingConstructorTest(){
        AnimalBackAndForth animal1 = new AnimalBackAndForth(new Vector2d(1,1), 6, 0, 50);
        AnimalBackAndForth animal2 = new AnimalBackAndForth(new Vector2d(1,1), 6, 0, 50);
    ...
    public void MoveTest(){
        ...
        AnimalBackAndForth animal1 = new AnimalBackAndForth(new Vector2d(1, 1), 4, 0, 20);
        animal1.setDirection(MapDirection.NORTH);
        animal1.setCurrentGene(0);
        animal1.setGenomeDirection(GenomeDirection.RIGHT);
        animal1.setGene(0, 0);
        animal1.setGene(1, 2);
        animal1.setGene(2, 1);
        animal1.setGene(3, 4);
        ...
        animal2.setGenomeDirection(GenomeDirection.RIGHT);
        animal2.setGene(0, 6);
        animal2.setGene(1, 4);
        ...
        animal3.setGenomeDirection(GenomeDirection.RIGHT);
        animal3.setGene(0, 0);
        animal3.setGene(1, 4);
